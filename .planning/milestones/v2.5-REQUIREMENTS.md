...
- [x] **SIM-01**: kNN neighbors are recomputed on the **enriched vector**, and the
...
- [x] **SIM-02**: Every neighbor match **explains why** — a per-match shared-attribute
...
- [x] **SIM-03**: The similarity edge set is recomputed from the new neighbors with the
...
- [x] **PERF-05**: The **app-wide SSR-hydration miss is fixed at the shared boundary** — a
...
- [x] **PERF-06**: The **~4s shell-chunk parse gap is reduced** — heavy static imports are
