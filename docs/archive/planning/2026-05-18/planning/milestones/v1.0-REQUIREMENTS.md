# Requirements Archive: v1.0 ACC Users Graph + Access Analysis Dashboard

**Archived:** 2026-05-08
**Status:** SHIPPED

This is the v1.0 requirements snapshot at milestone shipping. For current/active requirements, run `/gsd:new-milestone` to create the next milestone's REQUIREMENTS.md.
...
- [x] **UI-03**: User can access the filter panel and side detail panel simultaneously on screens ≤1280px wide — layout fix shipped via Plan 03-03 (commits 0f9a71f, 563a58c); doc-drift checkbox flipped at v1.0 archival
