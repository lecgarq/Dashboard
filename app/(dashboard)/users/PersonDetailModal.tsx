...
// PersonAvatar is in its own module to avoid a PersonDetailModal ↔ UserProfilePanel cycle.
// Named PersonAvatar here so JSX refs in this file work unchanged.
...
// Re-export PersonAvatar so existing importers of `PersonDetailModal` still work.
// (UserProfilePanel.tsx imports PersonAvatar from this file — the re-export
// preserves backward compat without re-introducing the cycle.)
