...
// ActiveFilterPill will move to ./DirectoryFilterBar (USR-01 decomposition, Wave 6, Task 2).
...
// ActivityAuditPanel moved to ./ActivityAuditPanel (USR-01 decomposition, Wave 6).
