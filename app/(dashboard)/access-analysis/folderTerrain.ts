// REF-01 SPLIT-01 in progress (Task 1 of 2) — Model + Layout extracted.
// Scene + Camera sections remain inline pending Task 2.
/**
 * folderTerrain.ts
 *
...
// ---------------------------------------------------------------------------
// Imports needed for the still-inline Scene and Camera sections
// ---------------------------------------------------------------------------
import { type FolderTerrainData, type TerrainCell, type Pt, TERRAIN, colorForRank, barHeight } from "./folderTerrainModel";
import { type SharedAxes, projectOntoAxes } from "./folderTerrainLayout";
