...
export function ActivityCoverageBadge({
  ...
  return (
    <span
      ...
      className={`inline-flex items-center gap-1 rounded-md border border-border bg-muted/60 px-1.5 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground${className ? ` ${className}` : ""}`}
    >
      {covered > 0 && (
        <span
          aria-hidden
