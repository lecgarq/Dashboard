  ...
  if (rows.length === 0) {
    ...
    return (
      <div
        ...
        className="flex h-[240px] flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-border/60 px-6 text-center text-sm text-muted-foreground"
      >
  ...
  if (summary.totalTypeGuids > 0 && summary.resolvedTypeGuids === 0) {
    return (
      <div
        ...
        className="flex h-[240px] flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-border/60 px-6 text-center text-sm text-muted-foreground"
      >
        <svg viewBox="0 0 24 24" fill="none" className="h-10 w-10 opacity-40" stroke="currentColor" strokeWidth="1.5">
  ...
  return (
    <div>
      ...
      {captionParts.length > 0 && (
        <p data-testid="issue-type-coverage-caption" className="mt-2 text-[11px] text-muted-foreground">
          {captionParts.join(" · ")}
        </p>
      )}
    </div>
